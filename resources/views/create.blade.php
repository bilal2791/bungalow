    ...
    <div class="row justify-content-center bg-white shadow mt-4 mx-3 pb-3 py-4">
        <div class="col-lg-11">
            <div class="d-flex justify-content-end"><a href="{{route('customer')}}" class="btn btn-primary mb-3">Show Products</a></div>
                        ...
                        <form method="POST" action="{{ route('customer.store') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="designation_id" id="designation_id"  class="form-control @error('designation_id') is-invalid @enderror" required autocomplete="country" autofocus>

                                    <option value="" label="Select designation ... " selected="selected">Select a designation ... </option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control @error('fullname') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
